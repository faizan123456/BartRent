...
const Header = (props) => {
  ...
  // loginModalRefer = ({ handleShow }) => {
  //   console.log("loginModalRef -> handleShow", handleShow);
            ...
            <div>
              <Grid container alignItems="center" className={classes.root}>
                ...
                <i
                  ...
                  style={{ color: "red", fontSize: 15, marginLeft: 10 }}
                ></i>
                <i
                  className="fa fa-twitter"
                  style={{ color: "blue", fontSize: 15, marginLeft: 10 }}
                ></i>
              </Grid>
            </div>

            <div style={{ marginLeft: 495 }}>
              <Grid
                container
                alignItems="center"
      ...
      <AppBar className={classes.navBar} position="static">
        <Toolbar>
          ...
          >
            ...
            <span className="text-warning h2 text-bold ml-2">Bart</span> {"&"}{" "}
            <span className="text-light h2 text-bold mr-2">Rent</span>
          </Link>
          <Grid
            style={{
              marginLeft: 375,
          ...
          >
            <Link className="btn btn-light btn-sm mr-2" to="/">
              Home
            </Link>
            <div className="btn-group">
              <button
                type="button"
                className="dropdown-toggle btn btn-light btn-sm mr-2"
              ...
              >
                <Link to="/rentalContent" className="dropdown-item">
                  Go TO Rentals
                </Link>
            ...
            <div className="btn-group dropdown">
              <button
                type="button"
                className="btn btn-light btn-sm mr-2 dropdown-toggle"
                data-toggle="dropdown"
                aria-haspopup="true"
                aria-expanded="false"
              >
              ...
              >
                <Link to="bartsContent" className="dropdown-item">
                  Go to Barts
                </Link>
                <div className="dropdown-divider"></div>
