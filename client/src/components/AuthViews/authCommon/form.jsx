...
class Form extends Component {
  ...
  handleOn = (event) => {
    console.log("handle On", event.target.name);
  };
  handleIsChecked = (event) => {
    const { target: input } = event;
    // console.log("checkded", event.target.checked);
    // const inp = { isChecked: input.checked };
  ...
  handleChange = (event) => {
    const { target: input } = event;
    console.log("i am handle change-->", event);
    const errors = { ...this.state.errors };
  ...
  renderCheckBox(name, value, label, error) {
    return (
